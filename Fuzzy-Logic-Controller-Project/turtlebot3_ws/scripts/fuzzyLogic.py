...
def movement():
    ...
    velXOutOA, velZOutOA = fuzzyContrObstacle.rullBase(
        regions_["fright"], regions_["fleft"], min(regions_["front1"], regions_["front2"])
    )

    velXOut, velZOut = combining.combine(
        min(regions_["front1"], regions_["front2"]),
        regions_["fright"],
        regions_["fleft"],
        regions_["bright"],
        velXOutRWF,
